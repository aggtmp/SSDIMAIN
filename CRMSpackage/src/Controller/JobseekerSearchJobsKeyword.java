...
import javax.sql.*;
import java.io.*;
public class JobseekerSearchJobsKeyword extends HttpServlet
{
public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
{
	...
	try
	{
		...
		out.println("<td>Required Experience</td><td>Status</td><td></td></tr>");
		while(rs.next())
			{
	...
	{
		out.println("Exception has beeen caught JobseekerSearchJobsKeyword");
		out.println(e);
	}
}
}
