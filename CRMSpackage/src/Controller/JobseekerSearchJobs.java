...
import java.sql.*;
import javax.sql.*;
public class JobseekerSearchJobs extends HttpServlet
{
public void doGet(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
{
	...
	try
	{
		...
		out.println("<html><body bgcolor=lightcyan><a href=JobseekerHome.jsp>HOME</a><center>");
		...
		out.println("<td>Required Experience</td><td>Status</td><td>Apply</td></tr>");
	...
	{
		out.println("The Exception has been caught at JobseekerSearchJobs Servlet class");
		out.println(e);
	}
}
}
