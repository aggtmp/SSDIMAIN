...
public void doPost(HttpServletRequest req,HttpServletResponse res) throws ServletException,IOException
{
	...
	try
	{
		...
		PreparedStatement ps=con.prepareStatement("update recruiterinformation set qualification=?,homeno=?,streetname=?,city=?,state=?,country=?,pincode=?,phonenumber=?,mobilenumber=?,emailid=?,passportno=?,phomeno=?,pstreetname=?,pcity=?,pstate=?,pcountry=?,ppincode=? where username=?");
