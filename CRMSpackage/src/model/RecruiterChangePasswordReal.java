...
import javax.sql.*;
public class RecruiterChangePasswordReal extends HttpServlet 
{
public void doPost(HttpServletRequest req,HttpServletResponse res)throws ServletException,IOException
{
	...
	try
	{
		...
		PreparedStatement pst=con.prepareStatement("update recruiterinformation set password=? where username=?");
